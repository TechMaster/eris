module github.com/TechMaster/eris

go 1.17

require (
	github.com/TechMaster/core v0.1.53
...
require (
	...
	github.com/iris-contrib/middleware/cors v0.0.0-20220605200020-e50b808c7502 // indirect
